...
export default {
	async fetch(request, env, ctx): Promise<Response> {
		...
		registerAppResource(server, "stock Widget","ui://stock-ui",{description: "UI of the stock tool"}, async ()=> {
			return {
				contents:[{
					uri:"ui://stock-ui",
					text:widgetHtml,
		...
		// 명세 정의
		registerAppTool(server, "get-stock-price", {
